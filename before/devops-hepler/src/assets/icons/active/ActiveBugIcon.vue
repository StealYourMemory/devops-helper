<template>
  <svg t="1715775399857" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
       p-id="6500" id="mx_n_1715775399858" :width="width" :height="height">
    <path
        ...
        p-id="6501" fill="#F56C6C"></path>
    <path d="M672 240a160 160 0 0 0-320 0v21.344h320V240z" p-id="6502" fill="#F56C6C"></path>
  </svg>
</template>
<script setup lang="ts">
import type SvgConfig from '@/@types/svgConfig';

withDefaults(defineProps<SvgConfig>(), {
  width: 24,
  height: 24
})
</script>